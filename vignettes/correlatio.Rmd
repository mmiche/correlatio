...
Other reason: There are plenty of R packages which provide all sorts of possibilities regarding correlation, except for what this correlatio package offers. These other packages, which I was able to find, are called: [correlation](https://easystats.github.io/correlation/), [corrr](https://corrr.tidymodels.org/), [correlated](https://CRAN.R-project.org/package=correlated), [ppcor](https://CRAN.R-project.org/package=ppcor), [corrmorant](https://github.com/r-link/corrmorant), [corrgrapher](https://modeloriented.github.io/corrgrapher/), [linkspotter](https://linkspotter.sigmant.net/index.html).
